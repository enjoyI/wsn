    ...
    public void paintComponent (Graphics g) {
        ...
        for(int i=0;i<tgData.nodes.size();++i){
        	if(pntInViewport(tgData.nodes.get(i))==1){
        		g.fillOval((int)((tgData.nodes.get(i).xPos-xPos)*pixPerReal-nodeRadius),
        				(int)((tgData.nodes.get(i).yPos-yPos)*pixPerReal-nodeRadius),
        ...
        for(int i=0;i<tgData.gateways.size();++i){
        	if(pntInViewport(tgData.gateways.get(i))==1){
        		g.fillOval((int)((tgData.gateways.get(i).xPos-xPos)*pixPerReal-gatewayRadius),
        				(int)((tgData.gateways.get(i).yPos-yPos)*pixPerReal-gatewayRadius),
